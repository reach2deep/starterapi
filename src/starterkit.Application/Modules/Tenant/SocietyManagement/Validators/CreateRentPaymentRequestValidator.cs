...
{
    public class CreateRentPaymentRequestValidator : AbstractValidator<CreateRentPaymentRequest>
    {
        public CreateRentPaymentRequestValidator()
        {
            RuleFor(x => x.LeaseAgreementId)
                .NotEmpty().WithMessage("Lease agreement ID is required");
